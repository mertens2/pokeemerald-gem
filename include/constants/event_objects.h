...
#define OBJ_EVENT_GFX_MAY_WALK_SIMPLE  		     251
...
#define OBJ_EVENT_GFX_VAR_10  (OBJ_EVENT_GFX_VARS + 0x10) // 240
...
#define OBJ_EVENT_GFX_VAR_14  (OBJ_EVENT_GFX_VARS + 0x14)
#define OBJ_EVENT_GFX_VAR_15  (OBJ_EVENT_GFX_VARS + 0x15)
#define OBJ_EVENT_GFX_VAR_16  (OBJ_EVENT_GFX_VARS + 0x16)
#define OBJ_EVENT_GFX_VAR_17  (OBJ_EVENT_GFX_VARS + 0x17)
#define OBJ_EVENT_GFX_VAR_18  (OBJ_EVENT_GFX_VARS + 0x18)
#define OBJ_EVENT_GFX_VAR_19  (OBJ_EVENT_GFX_VARS + 0x19)
#define OBJ_EVENT_GFX_VAR_1A  (OBJ_EVENT_GFX_VARS + 0x1A)
#define OBJ_EVENT_GFX_VAR_1B  (OBJ_EVENT_GFX_VARS + 0x1B)
#define OBJ_EVENT_GFX_VAR_1C  (OBJ_EVENT_GFX_VARS + 0x1C)
#define OBJ_EVENT_GFX_VAR_1D  (OBJ_EVENT_GFX_VARS + 0x1D)
#define OBJ_EVENT_GFX_VAR_1E  (OBJ_EVENT_GFX_VARS + 0x1E)
#define OBJ_EVENT_GFX_VAR_1F  (OBJ_EVENT_GFX_VARS + 0x1F) // 255
