...
#define PRONOUNS_HE 0
#define PRONOUNS_SHE 1
#define PRONOUNS_THEY 2
#define PRONOUNS_IT 3 // eeehhh i will figure it out
...
#define OPTIONS_TRAINING_MODE_OFF 0
#define OPTIONS_TRAINING_MODE_ON 1
...
#define OPTIONS_TEXT_SKIP_OFF      0
#define OPTIONS_TEXT_SKIP_NOSCROLL 1
#define OPTIONS_TEXT_SKIP_NOCLOSE  2
#define OPTIONS_TEXT_SKIP_SKIPALL  3
