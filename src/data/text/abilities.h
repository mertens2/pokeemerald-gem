...
static const u8 sPickupDescription[] = _("En Combate: Recupera su baya.\nEn Mapa: recoje objetos.");
...
static const u8 sToughClawsDescription[] = _("Sus grandes garras potencian\nlos ataques de contacto.");
...
static const u8 sAerilateDescription[] = _("Ataques Normales se hacen\nVoladores y se potencian.");
...
static const u8 sBerserkDescription[] = _("Enloquece al tener pocos PS,\nsubiendo su Ataque Especial.");
...
static const u8 sIntrepidSwordDescription[] = _("Sube el ataque\nal entrar a combatir.");
...
static const u8 sScreenCleanerDescription[] = _("Activa Reflejo o Pantalla Luz\na su conveniencia.");
...
static const u8 sChillingNeighDescription[] = _("Sube su Ataque al ganarle\na un rival.");
static const u8 sGrimNeighDescription[] = _("Sube su Ataque Especial al\nganarle a un rival.");
static const u8 sAsOneIceRiderDescription[] = _("Rival no comerá bayas y sube\nsu Ataque al ganarle.");
static const u8 sAsOneShadowRiderDescription[] = _("Rival no comerá bayas y sube\nsu Ataque Especial al ganarle.");
static const u8 sDefenseBreakerDescription[] = _("Al bajar ofensiva del rival,\nbaja su defensiva.");
static const u8 sAttackBreakerDescription[] = _("Al bajar defensiva del rival,\nbaja su ofensiva.");
static const u8 sFutureVisionDescription[] = _("Prediciendo el futuro, ataques\nde tipo Psíquico no fallarán.");
static const u8 sDualBodyDescription[] = _("Contacto puede anular ataques\ny/o activar Canto Mortal.");
...
static const u8 sGiftGiverDescription[] = _("Ataques que requieran Objetos\nEquipados siempre funcionarán.");
#else
static const u8 sNoneDescription[] = _("No special ability.");
    static const u8 sStenchDescription[] = _("It's pest may make the foe\nflinch when it attacks.");
    static const u8 sDrizzleDescription[] = _("Entering the battlefield\nsummons rain for 5 turns.");
    static const u8 sSpeedBoostDescription[] = _("Boosts it's Speed\nwith each passing turn.");
    static const u8 sBattleArmorDescription[] = _("Armor protects weakpoints,\nblocking critical hits.");
    static const u8 sSturdyDescription[] = _("Surives with 1HP instead of\nfainting, if at full HP.");
    static const u8 sDampDescription[] = _("Dampens the ambient, thus\npreventing self-destruction.");
