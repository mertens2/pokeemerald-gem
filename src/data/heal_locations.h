static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LAVARIDGE_TOWN - 1] = {MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN), 9, 6},
    ...
    [HEAL_LOCATION_MAUVILLE_CITY_F1 - 1] = {MAP_GROUP(MAUVILLE_CITY_F1), MAP_NUM(MAUVILLE_CITY_F1), 16, 23},
};
